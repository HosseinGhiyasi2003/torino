  ...
  if (isError) {
    return (
      <div className="flex justify-center my-9">
        <h2 className="text-4xl text-red-500">مشکلی پیش اومده لطفا بعدا امتحان کنید</h2>
      </div>
    );
  }
          ...
          {data?.data.map((location) => (
            ...
            >
              ...
              <div className="flex justify-between items-center border-t-1 border-[#0000001F] px-[9px] py-1.5 mt-1.5">
                <button className="bg-primary text-white w-[99px] py-[3px] rounded-[4px] text-[15px] hover:bg-green-700 transition cursor-pointer">
                  رزرو
                </button>
